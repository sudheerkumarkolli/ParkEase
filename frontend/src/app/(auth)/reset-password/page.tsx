    ...
    <div className="min-h-[calc(100vh-8rem)] flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-md space-y-6">
        <div className="text-center space-y-2">
          <h2 className="text-2xl font-extrabold text-slate-800">Create New Password</h2>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full rounded-2xl border border-slate-100 bg-slate-950/90 pl-10 pr-4 py-3 text-xs text-white focus:border-emerald-500 focus:outline-none focus:ring-2 focus:ring-emerald-500/20"
                  />
                </div>
              </div>

              <div>
                <label className="block text-xs font-semibold text-slate-600 mb-1.5">Reset Token</label>
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full rounded-2xl border border-slate-100 bg-slate-950/90 pl-10 pr-4 py-3 text-xs font-mono text-white focus:border-emerald-500 focus:outline-none focus:ring-2 focus:ring-emerald-500/20"
                  />
                </div>
              </div>
...
export default function ResetPasswordPage() {
  return (
    <Suspense fallback={<div className="text-center py-20 text-xs text-slate-500">Loading reset form...</div>}>
      <ResetPasswordForm />
    </Suspense>
  );
}
