      ...
      <main className="flex-1 p-4 sm:p-6 lg:p-8 space-y-6 max-w-4xl">
        ...
        <div className="space-y-3">
          {loading ? (
            ...
            <div className="p-12 text-center rounded-3xl border border-dashed border-slate-800 bg-slate-900/30 space-y-2">
              ...
              >
                ...
                {!n.is_read && (
                  <button
                    ...
                    className="p-1.5 rounded-lg bg-slate-950 border border-slate-800 text-emerald-400 hover:bg-emerald-500/20 text-xs"
                    title="Mark as read"
                  >
