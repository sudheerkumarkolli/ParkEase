...
export default function ParkingDetailPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <div className="min-h-screen px-4 sm:px-6 lg:px-8 py-8 max-w-7xl mx-auto space-y-8">
      ...
      {/* Hero Showcase Card */}
      <div className="relative overflow-hidden rounded-3xl border border-slate-800 bg-slate-900/70 p-6 sm:p-8 backdrop-blur-2xl shadow-2xl space-y-6">
        <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-6">
          ...
          <div className="space-y-2 flex-1">
            ...
            <h1 className="text-2xl sm:text-4xl font-black text-white">{parking.name}</h1>
          ...
          {/* Quick Book CTA Box */}
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 w-full lg:w-auto bg-slate-950 p-4 rounded-2xl border border-slate-800">
            <div className="text-center sm:text-right px-4">
              ...
              <div className="text-2xl font-black text-emerald-400">
                {parking.price_per_hour} <span className="text-xs text-slate-300">Credits/hr</span>
              </div>
            </div>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 pt-4 border-t border-slate-800">
          <div className="rounded-2xl bg-slate-950/60 p-3 border border-slate-800/80 text-center">
            <div className="text-[11px] text-slate-400">Available Bays</div>
          ...
          <div className="rounded-2xl bg-slate-950/60 p-3 border border-slate-800/80 text-center">
            <div className="text-[11px] text-slate-400">Hours of Operation</div>
          ...
          <div className="rounded-2xl bg-slate-950/60 p-3 border border-slate-800/80 text-center">
            <div className="text-[11px] text-slate-400">Coordinates</div>
          ...
          <div className="rounded-2xl bg-slate-950/60 p-3 border border-slate-800/80 text-center">
            <div className="text-[11px] text-slate-400">Verification</div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="rounded-3xl border border-slate-800 bg-slate-900/60 p-6 space-y-3">
          ...
          <div className="grid grid-cols-2 gap-2 text-xs text-slate-300">
            {facilities.map((f, i) => (
              <div key={i} className="flex items-center gap-2 bg-slate-950 p-2.5 rounded-xl border border-slate-800/80">
      ...
      <div className="space-y-4">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-xs text-slate-400">Click on any AVAILABLE slot to preselect for booking</p>
          </div>
          {selectedSlotId && (
            <Link
