...
export default function QRCodeDisplay({ booking }: QRCodeDisplayProps) {
  return (
    <div className="relative overflow-hidden rounded-3xl border border-slate-100 bg-gradient-to-b from-slate-900/90 to-slate-950 p-6 backdrop-blur-2xl shadow-2xl space-y-6">
